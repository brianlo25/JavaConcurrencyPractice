...
public class ItemTaskForkJoinDataProcessor extends AbstractLoadDataProcessor implements ApplicationContextAware {
    ...
    public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
        ...
        taskDataProcessorList.add(applicationContext.getBean(CommonService.class));
        taskDataProcessorList.add(applicationContext.getBean(ItemService.class));
        taskDataProcessorList.add(applicationContext.getBean(ComplexTradeTaskService.class));
    }
}
